...
const formBuilder = (friend) => {
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" value="${friend.phoneNumber}" id="form-friend-number" placeholder="(123) 456-7890">
  </div>
  <div class="form-group">
    <label for="form-friend-relationship">Relationship:</label>
    <input type="text" class="form-control" value="${friend.relationship}" id="form-friend-relationship" placeholder="Who are you to me?">
  </div>
  `;
  return form;
};
